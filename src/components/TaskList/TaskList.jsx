    ...
    <div id='tasklist' className='h-[55%] overflow-x-auto flex items-center justify-start gap-5 flex-nowrap w-full py-5  mt-10'>
      <div className='flex-shrink-0 h-full p-5 w-[300px] bg-red-400 rounded-xl'>
        <div className='flex justify-between'>
            ...
            <h4 className='text-sm'>30 Dec 2024</h4>
        </div>
        <h2 className='mt-5 text-2xl font-semibold underline decoration-gray-200'>Complete React Project</h2>
        <p className='text-sm mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab, mollitia animi aperiam voluptas ex illum.</p>
      </div>
